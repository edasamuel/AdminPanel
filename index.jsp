...
<body>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                                <a class="nav-link" href="logout.jsp"><i class="fa fa-power -off">Logout</i> </a>
  ...
  <h1>Welcome to Admin panel.</h1> 
    <p>You can add your customized products from this panel and control those.</p>
    <img src="../images/adminnn.png" align="right" width=150 height=150>    
  </div>  
