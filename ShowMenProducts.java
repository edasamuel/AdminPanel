...
/**
 * Servlet implementation class ShowMenProducts
 */
@WebServlet("/ShowMenProducts")
public class ShowMenProducts extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String type = request.getParameter("selecttype");
		String tablename = "mencollections";
		ResultSet rs = null;
		...
		out.println(" <!doctype html>\r\n" + 
				...
				"    <title>Sufee Admin - Men Collection</title>\r\n" + 
				...
				"                      <form action=\"ShowMenProducts\" method=\"post\">\r\n" + 
				"                      			    \r\n" + 
