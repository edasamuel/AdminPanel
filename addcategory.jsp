                    ...
                    <div class="card">
                      ...
                      <form action="../ProductAdd" method="post">
                      		...
                      		<label for="email">Item Type : </label>
                      		  <select name="selectitem" id="selectitems" class="form-control">
						    ...
						    <div class="form-group">
						      ...
						      <input type="text" class="form-control" id="email" placeholder="Enter Product name" name="pname">
						    </div>
						     <div class="form-group">
						      <label for="email">Size : </label>
						      <input type="text" class="form-control" id="email" placeholder="Enter size" name="size">
						    </div>
						    <div class="form-group">
