...
<head>
    ...
    <title>Sufee Admin - Category</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-id-badge"></i><a href="mencollection.jsp">Men</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="womencollection.jsp">Women</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
                    ...
                    <div class="card">
                      ...
                      <form action="../ProductUpdate" method="post">
						    ...
						    <div class="form-group">
						      ...
						      <input type="text" class="form-control" id="email" placeholder="Enter Product id" name="pid">
						    </div>
						    
						     <div class="form-group">
                      		 <label for="email">Category : </label>
                      		 <select name="selectcategory" id="Selectcategory" class="form-control">
                                <option value="mencollection" selected>Men Collection</option>
                                <option value="womencollection">Women Collection</option>
                              </select>
                      		</div>
       ...
       <div class="col-lg-10">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                      <form action="../ProductUpdate1" method="post">
                      		 <div class="form-group">
                      		 <label for="email">Category : </label>
                      		 <input type="text" class="form-control" id="email" placeholder="Enter Product name" name="selectcategory" value="<%=  session.getAttribute("ud1") %>">
                      		</div>
                      		
                      		 <div class="form-group">
                      		 <label for="email">Type : </label>
                      		 <input type="text" class="form-control" id="email" placeholder="Enter Product name" name="selecttype" value="<%=  session.getAttribute("ud2") %>">
                      		</div>
                      		
                      		<div class="form-group">
                      		<label for="email">Item Type : </label>
                      		<input type="text" class="form-control" id="email" placeholder="Enter Product name" name="selectitem" value="<%=  session.getAttribute("ud3") %>">
                      		</div>
                      		
						    <div class="form-group">
						      <label for="email">Product Name: </label>
						      <input type="text" class="form-control" id="email" placeholder="Enter Product name" name="pname" value="<%=  session.getAttribute("ud4") %>">
						    </div>
						     <div class="form-group">
						      <label for="email">Size : </label>
						      <input type="text" class="form-control" id="email" placeholder="Enter size" name="size" value="<%=  session.getAttribute("ud5") %>">
						    </div>
						    <div class="form-group">
						      <label for="email">Price : </label>
						      <input type="text" class="form-control" id="email" placeholder="Enter price" name="price" value="<%=  session.getAttribute("ud6") %>">
						    </div>
						     <div class="form-group">
